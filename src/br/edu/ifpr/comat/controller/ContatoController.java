...
public class ContatoController {
	...
	public void save(int idCli, 
			String nome,
			String telefone,
			String celular,
			String email,
			String funcao){
		new ContatoDAO().insert(new Contato(null, nome, telefone, celular, email, funcao, new ClienteController().search(idCli)));
		
	}
	
	public void alter(int idCon,
			String nome,
			String telefone,
			String celular,
			String email,
